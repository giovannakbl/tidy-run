...
const modelTasksReducer = (state = initialStateModelTasks, action) => {
    switch (action.type) {
        ...
        case ModelTasksActionTypes.FETCH_ALL_MODEL_TASKS_SUCCESS: {
          return { ...state, loading: false, error: undefined,  data: {...state.data, modelTasksList: action.payload.model_tasks }};
        }
        ...
        case ModelTasksActionTypes.EDIT_MODEL_TASK_SUCCESS: {
          return { ...state, loading: false, error: undefined,  data: {...state.data, modelTask: action.payload.model_task }};
        }
        case ModelTasksActionTypes.DELETE_MODEL_TASK_SUCCESS: {
          return { ...state, loading: false, error: undefined, data: {...state.data, modelTask: initialStateModelTasks.data.modelTask }};
        }
